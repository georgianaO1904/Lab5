...
public class StartedServiceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intent.setComponent(new ComponentName("ro.pub.cs.systems.eim.lab05.startedservice", "o.pub.cs.systems.eim.lab05.StartedService"));
        startService(intent);
    ...
    protected void onDestroy() {
        ...
        intent.setComponent(new ComponentName("ro.pub.cs.systems.eim.lab05.startedservice", "ro.pub.cs.systems.eim.lab05.StartedService"));
        stopService(intent);
        super.onDestroy();
    }
